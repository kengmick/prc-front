<template>
  ...
  <div
    class="relative w-screen h-[100%] border-box border-[#9DFCBA] border-[2px] overflow-y-scroll"
  >
    <nuxt-img
      class="custom_b"
      format="webp"
    ...
    <!-- header -->
    <section
      class="h-[38px] w-screen bg-black flex items-center justify-center fixed l-0 top-[48px] ml-[-2px] border-[#9DFCBA] border-[2px] z-50"
    >
    ...
    >
      <section class="w-[95%] flex-grow flex flex-col">
        <!-- info box -->
        <div
          class="w-[full] h-full bg-main-green bg-opacity-50 flex flex-col p-[10px] shadow-2xl"
        >
        ...
        <div
          class="w-full h-[65vh] mt-[8px] flex justify-around items-end gap-2"
        >
          <!-- logo -->
          <div class="w-[50%] h-[200px] shadow-2xl">
            <nuxt-img
          ...
          <!-- first featured card  -->
          <!-- <div v-if="band.hasFeaturedCard" class="w-[50%] h-[120px] shadow-2xl">
            <NuxtLink
              :to="{
            ...
            >
              <div v-if="band.cardType === 'band'">
                <MobileBand :band="band.cardData" :fullCard="true" />
              </div>
          ...
          <div
            class="h-[200px] w-1/2 bg-main-green flex flex-col justify-center items-center"
      ...
      <section
        class="w-[30%] h-auto bg-main-green flex flex-col justify-between items-center pt-[3px] shadow-2xl"
      >
        <NuxtLink
    ...
    <!-- buttons  -->
    <section
      class="flex justify-around items-center fixed bottom-0 bg-black w-screen h-[40px]"
    >
      <div
